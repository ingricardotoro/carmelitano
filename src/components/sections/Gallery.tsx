...
const galleryCategories = [
  ...
  },
  {
    ...
    name: 'Graduados',
    icon: Trophy,
    description: 'Desarrollo físico y trabajo en equipo',
    color: 'from-yellow-500 to-orange-500',
    images: [
      { src: '/images/gallery/graduados/graduados (1).jpeg', title: 'Cancha de Fútbol', description: 'Espacio deportivo principal' },
      { src: '/images/gallery/graduados/graduados (2).jpeg', title: 'Gimnasio', description: 'Actividades físicas techadas' },
      { src: '/images/gallery/graduados/graduados (3).jpeg', title: 'Torneo Escolar', description: 'Competencia y diversión' },
      { src: '/images/gallery/graduados/graduados (4).jpeg', title: 'Cancha de Fútbol', description: 'Espacio deportivo principal' },
      { src: '/images/gallery/graduados/graduados (5).jpeg', title: 'Gimnasio', description: 'Actividades físicas techadas' },
      { src: '/images/gallery/graduados/graduados (6).jpeg', title: 'Torneo Escolar', description: 'Competencia y diversión' },
      { src: '/images/gallery/graduados/graduados (7).jpeg', title: 'Cancha de Fútbol', description: 'Espacio deportivo principal' },
      { src: '/images/gallery/graduados/graduados (8).jpeg', title: 'Gimnasio', description: 'Actividades físicas techadas' },
      { src: '/images/gallery/graduados/graduados (9).jpeg', title: 'Torneo Escolar', description: 'Competencia y diversión' },
      { src: '/images/gallery/graduados/graduados (10).jpeg', title: 'Cancha de Fútbol', description: 'Espacio deportivo principal' },
      { src: '/images/gallery/graduados/graduados (11).jpeg', title: 'Gimnasio', description: 'Actividades físicas techadas' },
      { src: '/images/gallery/graduados/graduados (12).jpeg', title: 'Torneo Escolar', description: 'Competencia y diversión' },
    ]
  }
]
